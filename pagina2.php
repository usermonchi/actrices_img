...
<title>PRÁCTICA EN CASA P'AL EXAMEN</title>
...
<main role="main">
  ...
  <section class="jumbotron text-center">
    <div class="container">
      <h1>PLANTILLA PÁGINA CONTENIDOS<br>Práctica casa</h1>
      <p class="lead text-muted">Plantilla de artículos</p>
      <p>
  ...
  <div class="container">
    <div class="row">  <!-- Row del artículo principal  -->
        <div class="col-md-6"> 
          <img src="<?php echo ACTRICES[$idPaginal]['imgPrincipal'] ?>" alt="no sale ná" class="img-fluid">
        </div>
        
        <div class="col-md-6"> 
            <h1><?php echo ACTRICES[$idPaginal]['titulo'] ?> </h1>
            <p class="card-text"><?php echo ACTRICES[$idPaginal]['texto']?></p>
        ...
        <div class="col-md-6 py-3"> 
          ...
          <?php
            foreach (ACTRICES as $key => $valore) {
              echo '<div class="col-4 p-3"> <a href="' . $valore["url"] . '"> <img src="' . $valore["imgPrincipal"] . '" alt="na de ná" class="img-fluid"></a></div>';
            }
          ?>
        </div>
        </div>
        ...
        <div class="col-md-6 py-3">
          ...
          <?php 
            foreach (ACTRICES as $key => $value) {
              echo '<a href="' . $value['url'] . '"> ' . $value['titulo'] .'</a><br>';
            }
            ?>
        </div>
